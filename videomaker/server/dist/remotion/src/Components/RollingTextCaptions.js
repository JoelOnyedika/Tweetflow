...
export const RollingTextCaptions = ({ data }) => {
    ...
    const renderRollingText = () => {
        return captions.map((caption, captionIndex) => {
            ...
            const wordsToShow = Math.floor(((currentTimeMs - caption.startMs) / totalCaptionDuration) *
                words.length);
            return (_jsx("div", { style: {
                    ...
                    zIndex: 10,
                        ...
                        width: "100%",
                    }, children: words.slice(0, wordsToShow).map((word, wordIndex) => (_jsx("span", { style: {
                        ...
                        }, children: word }, wordIndex))) }) }, captionIndex));
        });
    };
