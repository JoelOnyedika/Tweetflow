...
def generate_tiktok_video(data, output_filename="output.mp4"):
    ...
    if data['image']:
        if data['image'].endswith(('mp4', 'mov', 'avi')):
            background_clip = center_video_in_tiktok_frame(data['image'], background_color=hex_to_rgb(data["backgroundColor"]))
