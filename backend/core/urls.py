...
from core.views.views_voice import (
    get_voice_models,
    get_voice_models_by_id,
    upload_voice,
)
...
from core.views.views_template import (
    delete_template,
    UploadTemplatesView,
    get_templates_by_id,
    get_templates,
...
from core.views.views_videos import (
    get_videos_by_id,
    delete_video_by_id,
    change_video_upload_time,
    edit_scheduled_video,
    filter_videos_by_platforms,
    upload_video,
    update_video_schedule,
)
...
urlpatterns = [
    ...
    path(
        "get-templates-by-id/<uuid:pk>/",
        get_templates_by_id,
        name="get_templates_by_id",
    ),
    ...
    path(
        "delete-video-by-id/<uuid:pk>/", delete_video_by_id, name="delete_video_by_id"
    ),
    path(
        "change-video-upload-time/<uuid:pk>/",
        change_video_upload_time,
        name="change_video_upload_time",
    ),
    path(
        "edit-scheduled-video/<uuid:pk>/",
        edit_scheduled_video,
        name="edit_scheduled_video",
    ),
    path(
        "videos-by-platforms/<uuid:pk>/",
        filter_videos_by_platforms,
        name="filter_videos_by_platforms",
    ),
    path("get-user-settings/", get_settings, name="get_settings"),
    path("save-user-settings/", save_settings, name="save_settings"),
    path(
        "update-video-schedule/<uuid:pk>/",
        update_video_schedule,
        name="update_video_schedule ",
    ),
]
